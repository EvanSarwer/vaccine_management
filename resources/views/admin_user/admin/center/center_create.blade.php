        ...
        <div class="col-lg-12">
            ...
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-edit">Add New Center</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form method="POST" action="{{ route('admin.center.create.post') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="hospital" type="text" class="form-control @error('hospital') is-invalid @enderror" id="hospital" value="{{ old('hospital') }}">
                        @error('hospital')
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="location_link" class="form-control @error('location_link') is-invalid @enderror" id="location_link" style="height: 100px">{{ old('location_link') }}</textarea>
                        @error('location_link')
                          <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
