          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="filter">
                  <a href="{{ route('admin.send.email.notification', null) }}" class="btn btn-primary">Send Mail Notice</a>
                </div>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    @if(count($messages) > 0)
                      ...
                      <tr class="{{ ($message->status === 'unseen') ? 'table-primary' : '' }}">
                        ...
                        <td>
                          <a href="{{ route('admin.send.email.notification', $message->email) }}" class="btn btn-warning btn-sm {{ $message->email ? '' : 'disabled' }}">Reply</a>
                        </td>
                      </tr>
                      @endforeach
                    @else
