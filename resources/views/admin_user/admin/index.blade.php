      ...
      <div class="row">
        ...
        <div class="col-xxl-3 col-md-6">
          ...
          <div class="card info-card customers-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Total Users <span>| Registered In Our System</span></h5>
        ...
        <div class="col-xxl-3 col-md-6">
          ...
          <div class="card info-card customers-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Taking Vaccinaton <span>| User Count</span></h5>
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6>{{ $taking_vaccination_user_number}}</h6>
                  {{-- <span class="text-danger small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">decrease</span> --}}
        ...
        <div class="col-xxl-3 col-md-6">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Top Vaccine <span>| Most Number Of User Under Vaccination</span></h5>
        ...
        <div class="col-xxl-3 col-md-6">
          <div class="card info-card revenue-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Total Vaccines <span>| Updated Today</span></h5>
