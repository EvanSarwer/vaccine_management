            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form method="POST" action="{{ route('admin.vaccine.create.post') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          {{-- <input name="disease_id" type="text" class="form-control @error('disease_id') is-invalid @enderror" id="disease_id" value="{{ $disease->name }}"> --}}
                          <select class="form-select @error('disease_id') is-invalid @enderror" name="disease_id" aria-label="Select Disease" id="disease_id">
